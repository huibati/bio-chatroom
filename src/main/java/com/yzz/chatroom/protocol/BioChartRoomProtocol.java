 ...
 * @Since 0.0.1
 */
public class BioChartRoomProtocol implements Protocol {

    private static volatile BioChartRoomProtocol bioChartRoomProtocol;

    private BioChartRoomProtocol() {
    }
    ...
    public static BioChartRoomProtocol getInstance() {
        if (null != bioChartRoomProtocol) {
            return bioChartRoomProtocol;
        }
        synchronized (BioChartRoomProtocol.class) {
            if (null == bioChartRoomProtocol) {
                bioChartRoomProtocol = new BioChartRoomProtocol();
            }
        }
        return bioChartRoomProtocol;
    }
